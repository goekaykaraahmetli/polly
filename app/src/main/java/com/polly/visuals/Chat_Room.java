...
public class Chat_Room extends Fragment {
    ...
    private static final ResponseCommunicator communicator = initialiseCommunicator();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        root.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                while (i.hasNext()) {
                    //System.out.println(((DataSnapshot)i.next()).getKey());
                    DataSnapshot next = (DataSnapshot) i.next();
                    if (((String) next.getKey()).equals("id")) {
                        long id = (Long) ((DataSnapshot) next).getValue();
                        next = (DataSnapshot) i.next();
